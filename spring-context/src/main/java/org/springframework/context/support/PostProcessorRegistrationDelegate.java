...
final class PostProcessorRegistrationDelegate {
	...
	public static void registerBeanPostProcessors(
		...
		/*
		 * beanFactory.getBeanPostProcessorCount()会得到默认容器中注册的 BeanPostProcessor 个数，
		 * 实际就是调用 List<BeanPostProcessor> beanPostProcessors = new CopyOnWriteArrayList<>()的size()方法，
		 * 默认的容器注册的 BeanPostProcessor 有：
